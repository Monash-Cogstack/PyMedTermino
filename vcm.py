...
class VCM(pymedtermino.Terminology):
  ...
  def icons_from_lexs(self, lexs, prioritary_associations = None, debug = 0):
    ...
    # Infection cannot be malformation
    if lexs.find(VCM_LEXICON[1, u"infection"]) and lexs.find(VCM_LEXICON[1, u"malformation"]):
      lexs = lexs.subtract(VCM_LEXICON[1, u"malformation"])
